...
/**
 * Nat's voice: a queue of chunks scheduled back to back on one timeline.
 *
...
/**
 * The context both halves share, plus the output chain Nat's voice runs
 * through: gain for muting, analyser so the die can move to its own voice.
 */
