 ...
 *
 * Only the handful that change what the die is doing. xAI's event stream is
 ...
 * cumulative event gives you "hello hello there hello there nat", so the two
  ...
  function handle(event) {
    ...
    switch (type) {
      ...
      case 'input_audio_buffer.speech_started':
        ...
        // already sent. Nat does not enjoy being cut off — see main.js.
      ...
      case 'response.done': {
        ...
        // If Nat said nothing there is no audio to wait on, so the turn ends
