...
This document sets out the limits of responsibility for Nat ("the App"). It is
...
- **"App"**: the Nat client, its proxy, and the materials in this repository.
...
- The App captures microphone audio, relays it to a xAI Grok speech-to-speech
  session, and renders what comes back as a twenty-sided die.
