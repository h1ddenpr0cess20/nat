...
describe('the proxy', () => {
  ...
  describe('a conversation picked back up', () => {
    const turns = [
      { role: 'user', content: 'what is behind the door?' },
      { role: 'assistant', content: 'Roll me. Eleven. It opens.' },
    ];
      ...
      assert.deepEqual(forwarded.slice(1, 3), [
        {
          ...
          item: {
            ...
            role: 'user',
            status: 'completed',
            content: [{ type: 'input_text', text: 'what is behind the door?' }],
          },
        },
        {
          type: 'conversation.item.create',
          item: {
            ...
            role: 'assistant',
            status: 'completed',
            content: [{ type: 'output_text', text: 'Roll me. Eleven. It opens.' }],
          },
        },
      ]);
